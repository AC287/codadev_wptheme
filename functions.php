...
function codadev_script_enqueue() {
  ...
  wp_enqueue_style('customstyle',get_template_directory_uri().'/css/codadev.css', array(), '1.0.4', 'all');
  ...
  wp_enqueue_script('customjs',get_template_directory_uri().'/js/codadev.js', array('jquery'), '1.0.4', true);
